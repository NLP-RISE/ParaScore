...
def scorer(system_scores, seg_score_test, args):
    ...
    print(
        "The pearson correlation between {} and human score is {}".format(
            args.metric, pearson_corrs
        )
    )
    print(
        "The spearman correlation between {} and human score is {}".format(
            args.metric, spearman_corrs
        )
    )
    ...
    with open("log.txt", "a+") as f:
        f.write("#-------------------------------------#\n")
        f.write(
            "In {} mode, The pearson correlation between {} and human score is {}\n".format(
                args.setting, args.metric, pearson_corrs
            )
        )
        f.write(
            "In {} mode, The spearman correlation between {} and human score is {}\n".format(
                args.setting, args.metric, spearman_corrs
            )
        )
