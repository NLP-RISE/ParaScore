...
class SUMStat:
    ...
    def get_fact_acc(self, auto_metrics=None):
        ...
        for metric in auto_metrics:
            ...
            for doc_id in self.data:
                if (
                    self.data[doc_id]["sys_summs"]["correct"]["scores"][metric]
    ...
    def fact_acc_sig_test_two(self, m1, m2):
        ...
        for i in trange(1000):
            ...
            for doc_id in sub_ids:
                if (
                    self.data[doc_id]["sys_summs"]["correct"]["scores"][m1]
                    > self.data[doc_id]["sys_summs"]["incorrect"]["scores"][m1]
                ):
                    m1_correct += 1
                if (
                    self.data[doc_id]["sys_summs"]["correct"]["scores"][m2]
    ...
    def __init__(self, path):
        ...
        self._systems = {
            ...
            "gu-en": [
                ...
                "UEDIN.6534",
                "GTCOM-Primary.6969",
                "CUNI-T2T-transfer-guen.6431",
                "aylien_mt_gu-en_multilingual.6826",
                "NICT.6603",
                "online-G.0",
                "IITP-MT.6824",
                "UdS-DFKI.6861",
            ...
            "kk-en": [
                "online-B.0",
                "NEU.6753",
                "rug_kken_morfessor.6677",
                "online-G.0",
                "talp_upc_2019_kken.6657",
                "NRC-CNRC.6895",
                "Frank_s_MT.6127",
                "NICT.6770",
                "CUNI-T2T-transfer-kken.6436",
                "UMD.6736",
                "DBMS-KU_KKEN.6726",
            ],
            "lt-en": [
